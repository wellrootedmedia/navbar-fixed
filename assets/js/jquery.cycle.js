(function (e, t) {
    ...
    function s(t, n, r) {
        ...
        if (!i)return;
        var s = !!t.cyclePause;
        if (s && i.paused)i.paused(t, i, n, r); else if (!s && i.resumed)i.resumed(t, i, n, r)
    }
    ...
    function f(n, r, o, a, f) {
        ...
        if (y.startingSlide !== t) {
            ...
            if (y.startingSlide >= o.length || y.startSlide < 0)y.startingSlide = 0; else d = true
        } else if (y.backwards)y.startingSlide = o.length - 1; else y.startingSlide = 0;
        if (y.random) {
            y.randomMap = [];
        ...
        r.css({position: "absolute", top: 0, left: 0}).hide().each(function (t) {
            var n;
            if (y.backwards)n = x ? t <= x ? o.length + (t - x) : x - t : o.length - t; else n = x ? t >= x ? o.length - (t - x) : x - t : o.length - t;
        ...
        if (T) {
            ...
            if (y.containerResize && N > 0 && C > 0)n.css({width: N + "px", height: C + "px"});
            if (y.containerResizeHeight && C > 0)n.css({height: C + "px"})
        }
        var _ = false;
        ...
        } else if (y.backwards)y.nextSlide = y.startingSlide === 0 ? o.length - 1 : y.startingSlide - 1; else y.nextSlide = y.startingSlide >= o.length - 1 ? 0 : y.startingSlide + 1;
        if (!y.multiFx) {
            var H = e.fn.cycle.transitions[y.fx];
            if (e.isFunction(H))H(n, r, y); else if (y.fx != "custom" && !y.multiFx) {
    ...
    function h(t, n) {
        t.addSlide = function (r, i) {
            ...
            if (e.isFunction(t.onAddSlide))t.onAddSlide(s); else s.hide()
        }
    }
    ...
    function p(n, i, s, o) {
        ...
        if ((s || !u.cyclePause) && i.nextSlide != i.currSlide) {
            ...
            if (i.multiFx) {
                if (o && (i.lastFx === t || ++i.lastFx >= i.fxs.length))i.lastFx = 0; else if (!o && (i.lastFx === t || --i.lastFx < 0))i.lastFx = i.fxs.length - 1;
                c = i.fxs[i.lastFx]
            }
            if (i.oneTimeFx) {
                c = i.oneTimeFx;
            ...
            i.busy = 1;
            if (i.fxFn)i.fxFn(a, f, i, h, o, s && i.fastOnEvent); else if (e.isFunction(e.fn.cycle[i.fx]))e.fn.cycle[i.fx](a, f, i, h, o, s && i.fastOnEvent); else e.fn.cycle.custom(a, f, i, h, o, s && i.fastOnEvent)
        } else {
            m()
        }
    ...
    function v(t, n) {
        var r = n ? 1 : -1;
        var i = t.elements;
        var s = t.$cont[0], o = s.cycleTimeout;
        if (o) {
            clearTimeout(o);
            s.cycleTimeout = 0
        }
        if (t.random && r < 0) {
            t.randomIndex--;
            if (--t.randomIndex == -2)t.randomIndex = i.length - 2; else if (t.randomIndex == -1)t.randomIndex = i.length - 1;
    ...
    e.fn.cycle.hopsFromLast = function (e, t) {
        ...
        if (t)n = i > r ? i - r : e.slideCount - r; else n = i < r ? r - i : r + e.slideCount - i;
        return n
    };
    ...
    e.fn.cycle.custom = function (t, n, r, i, s, o) {
        var u = e(t), a = e(n);
        var f = r.speedIn, l = r.speedOut, c = r.easeIn, h = r.easeOut, p = r.animInDelay, d = r.animOutDelay;
        a.css(r.cssBefore);
        if (o) {
            if (typeof o == "number")f = l = o; else f = l = 1;
            c = h = null
        }
        var v = function () {
    ...
    e.fn.cycle.defaults = {activePagerClass: "activeSlide", after: null, allowPagerClickBubble: false, animIn: null, animInDelay: 0, animOut: null, animOutDelay: 0, aspect: false, autostop: 0, autostopCount: 0, backwards: false, before: null, center: null, cleartype: !e.support.opacity, cleartypeNoBg: false, containerResize: 1, containerResizeHeight: 0, continuous: 0, cssAfter: null, cssBefore: null, delay: 0, easeIn: null, easeOut: null, easing: null, end: null, fastOnEvent: 0, fit: 0, fx: "fade", fxFn: null, height: "auto", manualTrump: true, metaAttr: "cycle", next: null, nowrap: 0, onPagerEvent: null, onPrevNextEvent: null, pager: null, pagerAnchorBuilder: null, pagerEvent: "click.cycle", pause: 0, pauseOnPagerHover: 0, prev: null, prevNextEvent: "click.cycle", random: 0, randomizeEffects: 1, requeueOnImageNotLoaded: true, requeueTimeout: 250, rev: 0, shuffle: null, skipInitializationCallbacks: false, slideExpr: null, slideResize: 1, speed: 1e3, speedIn: null, speedOut: null, startingSlide: t, sync: 1, timeout: 4e3, timeoutFn: null, updateActivePagerLink: null, width: null}
})(jQuery);
(function (e) {
    "use strict";
    ...
    e.fn.cycle.transitions.fadeout = function (t, n, r) {
        n.not(":eq(" + r.currSlide + ")").css({display: "block", opacity: 1});
    ...
    e.fn.cycle.transitions.shuffle = function (t, n, r) {
        ...
        r.random = 0;
        r.shuffle = r.shuffle || {left: -s, top: 15};
        r.els = [];
        ...
        r.fxFn = function (t, n, r, i, s) {
            ...
            o.animate(r.shuffle, r.speedIn, r.easeIn, function () {
                ...
                for (var a = 0; a < n; a++) {
                    if (s)r.els.push(r.els.shift()); else r.els.unshift(r.els.pop())
                }
                if (s) {
    ...
    e.fn.cycle.transitions.turnRight = function (t, n, r) {
        ...
        e.extend(r.cssBefore, {top: 0, left: 0, width: 0});
        r.animIn.left = 0;
        r.animOut.width = 0
    };
    e.fn.cycle.transitions.zoom = function (t, n, r) {
        r.before.push(function (t, n, r) {
            ...
            e.extend(r.animIn, {top: 0, left: 0, width: n.cycleW, height: n.cycleH});
    ...
    e.fn.cycle.transitions.cover = function (t, n, r) {
        ...
        r.before.push(function (t, n, r) {
            e.fn.cycle.commonReset(t, n, r);
            r.cssAfter.display = "";
            if (i == "right")r.cssBefore.left = -s; else if (i == "up")r.cssBefore.top = o; else if (i == "down")r.cssBefore.top = -o; else r.cssBefore.left = s
        });
        r.animIn.left = 0;
        r.animIn.top = 0;
        r.cssBefore.top = 0;
    ...
    e.fn.cycle.transitions.uncover = function (t, n, r) {
        ...
        r.before.push(function (t, n, r) {
            e.fn.cycle.commonReset(t, n, r, true, true, true);
            if (i == "right")r.animOut.left = s; else if (i == "up")r.animOut.top = -o; else if (i == "down")r.animOut.top = o; else r.animOut.left = -s
        });
        r.animIn.left = 0;
        r.animIn.top = 0;
        r.cssBefore.top = 0;
    ...
    e.fn.cycle.transitions.toss = function (t, n, r) {
        ...
        r.before.push(function (t, n, r) {
            e.fn.cycle.commonReset(t, n, r, true, true, true);
            if (!r.animOut.left && !r.animOut.top)e.extend(r.animOut, {left: i * 2, top: -s / 2, opacity: 0}); else r.animOut.opacity = 0
        });
        r.cssBefore.left = 0;
        r.cssBefore.top = 0;
        r.animIn.left = 0
    ...
    e.fn.cycle.transitions.wipe = function (t, n, r) {
        ...
        var o;
        if (r.clip) {
            if (/l2r/.test(r.clip))o = "rect(0px 0px " + s + "px 0px)"; else if (/r2l/.test(r.clip))o = "rect(0px " + i + "px " + s + "px " + i + "px)"; else if (/t2b/.test(r.clip))o = "rect(0px " + i + "px 0px 0px)"; else if (/b2t/.test(r.clip))o = "rect(" + s + "px " + i + "px " + s + "px 0px)"; else if (/zoom/.test(r.clip)) {
        ...
        var l = parseInt(f[0], 10), c = parseInt(f[1], 10), h = parseInt(f[2], 10), p = parseInt(f[3], 10);
        r.before.push(function (t, n, r) {
            if (t == n)return;
            var o = e(t), u = e(n);
            ...
            (function d() {
                ...
                u.css({clip: "rect(" + e + "px " + r + "px " + n + "px " + t + "px)"});
